...
Electronics and Communication Engineering graduate with a Minor in Robotics and Automation, skilled in embedded systems prototyping and real time 
system development. Enthusiastic about leveraging technology to build innovative solutions in automation, communication, and assistive technologies. 

## Academic Qualifications
- Bachelor of Technology – Electronics & Communication, Rajagiri School of Engineering & Technology (Autonomous), Kochi
  <br>CGPA 8.45 out of 10 | May, 2026 
...
### 3) Optimized Deployment of Heterogeneous Wireless Networks Using Machine Learning for 5G and Beyond
  **Objective**		: Developed a reinforcement learning based system to optimize base station placement in 5G Heterogenous Networks based 
on terrain, user and candidate locations data. 
  <br>**Technology Used**	: Python, NYUSIM propagation model, Reinforcement Learning 
...
- VLSI Design Verification Course – RSET

## 🛠 Skills

- **Languages:** Python, MATLAB, System Verilog, Assembly Language
- **Tools:** Arduino IDE, KiCad, Proteus, Keil uVision5, STM32CubeIDE, STM32CubeMX  
